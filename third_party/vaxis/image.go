...
// CodeLima changes: recognize bounded encoded images and compare placement z.
...
type placement struct {
	...
	w        int
	h        int
	z        int32 // CodeLima: a z-order change requires replacing the placement.
}
